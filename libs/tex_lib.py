...
def initTexFile(spec, rslts_dir, file):
    """
    Function to initialize the tex file
    file: The tex file
    """

    path = "{0}/{1}--{2}{3}{4}".format(rslts_dir, spec, prefix, file, suffix)
...
def writeIntoTexFile(spec, rslts_dir, file, data):
    """
    Function to write some data into the tex file
    spec: "average" or "median"
    rslts_dir: The directory to save the latex file
    file: The tex file
...
def beginTabular(spec, rslts_dir, file, nb_columns):
    """
...
def addDefaultTagsIntoTabular(spec, rslts_dir, file):
    """
...
def closeTabular(spec, rslts_dir, file):
    """
...
def closeTexFile(spec, rslts_dir, file):
    """
...
def cleanTexFile(spec, rslts_dir, file):
    """
